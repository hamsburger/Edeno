...
const LightIntensityInfo = ({ route, navigation }) => {
  ...
  const upperIdeal = lightIntensityData.upperIdeal;
  const lowerIdeal = lightIntensityData.lowerIdeal;
        ...
        <View paddingLeft={"30px"} paddingRight={"30px"} marginTop={"20px"}>
          {checkPlantCondition() == 0 ? (
            <Text style={[styles.alert, { color: "#1B461A" }]}>
              Your light intensity is within the ideal range. Your plant thanks
              you for taking great care of it!
            </Text>
          ) : checkPlantCondition() == -1 ? (
            <View>
              <Text style={styles.alert} marginBottom={"5px"}>
                Uh-oh.. Looks like your light intensity is below the recommended
                range.{" "}
              </Text>
            ...
            <View>
              <Text style={styles.alert} marginBottom={"5px"}>
                Uh-oh.. Looks like your light intensity is above the recommended
                range.{" "}
              </Text>
              <Text style={styles.tips}>
                Dont worry! Here's what you can do to help your{" "}
