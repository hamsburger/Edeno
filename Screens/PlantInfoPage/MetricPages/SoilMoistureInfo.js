...
const SoilMoistureInfo = ({ route, navigation }) => {
  ...
  const upperIdeal = soilMoistureData.upperIdeal;
  const lowerIdeal = soilMoistureData.lowerIdeal;
        ...
        <View paddingLeft={"30px"} paddingRight={"30px"} marginTop={"20px"}>
          {checkPlantCondition() == 0 ? (
            <Text style={[styles.alert, { color: "#1B461A" }]}>
              Your soil moisture level is within the ideal range. Your plant
              thanks you for taking great care of it!
            </Text>
          ) : checkPlantCondition() == -1 ? (
            <View>
              <Text style={styles.alert} marginBottom={"5px"}>
                Uh-oh.. Looks like your soil moisture is below the recommended
                range.{" "}
              </Text>
            ...
            <View>
              <Text style={styles.alert} marginBottom={"5px"}>
                Uh-oh.. Looks like your soil moisture is above the recommended
                range.{" "}
              </Text>
              <Text style={styles.tips}>
                Dont worry! Here's what you can do to help your{" "}
